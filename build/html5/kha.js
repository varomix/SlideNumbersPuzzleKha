...
var Block = function(x,y,width,height,color,img) {
	this.moveSpeed = 0.1;
	this.x = x;
	this.y = y;
	this.width = width;
...
Block.prototype = {
	...
	,render: function(gfx) {
		if(this.color != null) gfx.set_color(this.color);
		if(this.image != null) gfx.drawImage(this.image,this.x,this.y);
	}
...
Main.__name__ = ["Main"];
Main.main = function() {
	kha_System.init({ title : "Slide Numbers Puzzle", width : 768, height : 1280},function() {
		new Puzzle();
	});
};
Math.__name__ = ["Math"];
var Puzzle = function() {
	...
	kha_Assets.loadEverything($bind(this,this.create));
};
$hxClasses["Puzzle"] = Puzzle;
Puzzle.__name__ = ["Puzzle"];
Puzzle.prototype = {
	bg: null
	,block: null
	,blockSize: null
	...
	,blocksGrp: null
	,create: function() {
		this.bg = kha_Assets.images.bg2;
		this.blocksGrp = new Group();
		this.createBoard();
		this.blocksGrp.setPosition(24,188);
	...
	,createBoard: function() {
		...
		while(_g < 15) {
			var i = _g++;
			this.blk = new Block(col * this.blockSize,row * this.blockSize,this.blockSize,this.blockSize);
			this.blk.setImage(kha_Assets.images.block2);
			this.blocksGrp.add(this.blk);
			col++;
			if(col >= 4) {
				col = 0;
				row++;
...
var kha_ImageList = function() {
	this.zombieDescription = { files : ["zombie.png"], original_height : 285, type : "image", original_width : 260, name : "zombie"};
	this.zombieName = "zombie";
	this.zombie = null;
	this.woodDescription = { files : ["wood.jpg"], original_height : 600, type : "image", original_width : 600, name : "wood"};
	this.woodName = "wood";
	this.wood = null;
	this.shuffleDescription = { files : ["shuffle.png"], original_height : 128, type : "image", original_width : 128, name : "shuffle"};
	this.shuffleName = "shuffle";
	this.shuffle = null;
	this.settingsDescription = { files : ["settings.png"], original_height : 32, type : "image", original_width : 32, name : "settings"};
	this.settingsName = "settings";
	this.settings = null;
	this.quitDescription = { files : ["quit.png"], original_height : 128, type : "image", original_width : 128, name : "quit"};
	this.quitName = "quit";
	this.quit = null;
	this.playblockDescription = { files : ["playblock.png"], original_height : 100, type : "image", original_width : 200, name : "playblock"};
	this.playblockName = "playblock";
	this.playblock = null;
	this.muteDescription = { files : ["mute.png"], original_height : 128, type : "image", original_width : 128, name : "mute"};
	this.muteName = "mute";
	this.mute = null;
	this.gearDescription = { files : ["gear.png"], original_height : 512, type : "image", original_width : 512, name : "gear"};
	this.gearName = "gear";
	this.gear = null;
	this.block2Description = { files : ["block2.png"], original_height : 180, type : "image", original_width : 180, name : "block2"};
	this.block2Name = "block2";
	this.block2 = null;
	this.blockDescription = { files : ["block.png"], original_height : 128, type : "image", original_width : 128, name : "block"};
	this.blockName = "block";
	this.block = null;
	this.bgDescription = { files : ["bg.jpg"], original_height : 650, type : "image", original_width : 544, name : "bg"};
	this.bgName = "bg";
	this.bg = null;
	this.bg2Description = { files : ["bg2.jpg"], original_height : 1280, type : "image", original_width : 768, name : "bg2"};
	this.bg2Name = "bg2";
	this.bg2 = null;
};
...
kha_ImageList.prototype = {
	...
	,bg2Name: null
	,bg2Description: null
	,bg2Load: function(done) {
		kha_Assets.loadImage("bg2",function(image) {
			done();
		});
	}
	,bg2Unload: function() {
	...
	,bgName: null
	,bgDescription: null
	,bgLoad: function(done) {
		kha_Assets.loadImage("bg",function(image) {
			done();
		});
	}
	,bgUnload: function() {
	...
	,blockLoad: function(done) {
		kha_Assets.loadImage("block",function(image) {
			done();
		});
	}
	...
	,block2: null
	,block2Name: null
	,block2Description: null
	,block2Load: function(done) {
		kha_Assets.loadImage("block2",function(image) {
			done();
		});
	}
	,block2Unload: function() {
		this.block2.unload();
		this.block2 = null;
	}
	,gear: null
	...
	,gearLoad: function(done) {
		kha_Assets.loadImage("gear",function(image) {
			done();
		});
	}
	,gearUnload: function() {
	...
	,muteLoad: function(done) {
		kha_Assets.loadImage("mute",function(image) {
			done();
		});
	}
	,muteUnload: function() {
	...
	,playblock: null
	,playblockName: null
	,playblockDescription: null
	,playblockLoad: function(done) {
		kha_Assets.loadImage("playblock",function(image) {
			done();
		});
	}
	,playblockUnload: function() {
		this.playblock.unload();
		this.playblock = null;
	}
	,quit: null
	,quitName: null
	,quitDescription: null
	,quitLoad: function(done) {
		kha_Assets.loadImage("quit",function(image) {
			done();
		});
	}
	,quitUnload: function() {
	...
	,settingsLoad: function(done) {
		kha_Assets.loadImage("settings",function(image) {
			done();
		});
	}
	,settingsUnload: function() {
		this.settings.unload();
		this.settings = null;
	}
	,shuffle: null
	,shuffleName: null
	,shuffleDescription: null
	,shuffleLoad: function(done) {
		kha_Assets.loadImage("shuffle",function(image) {
			done();
		});
	}
	,shuffleUnload: function() {
		this.shuffle.unload();
		this.shuffle = null;
	}
	,wood: null
	...
	,woodLoad: function(done) {
		kha_Assets.loadImage("wood",function(image) {
			done();
		});
	}
	,woodUnload: function() {
	...
	,zombie: null
	,zombieName: null
	,zombieDescription: null
	,zombieLoad: function(done) {
		kha_Assets.loadImage("zombie",function(image) {
			done();
		});
	}
	,zombieUnload: function() {
		this.zombie.unload();
		this.zombie = null;
	}
...
var kha_SoundList = function() {
	this.pauseDescription = { files : ["pause.ogg"], type : "sound", name : "pause"};
	this.pauseName = "pause";
	this.pause = null;
	this.moveDescription = { files : ["move.ogg"], type : "sound", name : "move"};
	this.moveName = "move";
	this.move = null;
	this.clickDescription = { files : ["click.ogg"], type : "sound", name : "click"};
...
kha_SoundList.prototype = {
	...
	,clickLoad: function(done) {
		kha_Assets.loadSound("click",function(sound) {
			done();
		});
	}
	,clickUnload: function() {
		this.click.unload();
		this.click = null;
	}
	,move: null
	...
	,moveLoad: function(done) {
		kha_Assets.loadSound("move",function(sound) {
			done();
		});
	}
	,moveUnload: function() {
	...
	,pauseLoad: function(done) {
		kha_Assets.loadSound("pause",function(sound) {
			done();
		});
	}
...
var kha_BlobList = function() {
	this.success_oggDescription = { files : ["success.ogg"], type : "blob", name : "success_ogg"};
	this.success_oggName = "success_ogg";
	this.success_ogg = null;
	this.sounds_go_here_txtDescription = { files : ["sounds-go-here.txt"], type : "blob", name : "sounds_go_here_txt"};
	this.sounds_go_here_txtName = "sounds_go_here_txt";
	this.sounds_go_here_txt = null;
	this.click2_oggDescription = { files : ["click2.ogg"], type : "blob", name : "click2_ogg"};
	this.click2_oggName = "click2_ogg";
	this.click2_ogg = null;
	this.slideMusic_oggDescription = { files : ["slideMusic.ogg"], type : "blob", name : "slideMusic_ogg"};
	this.slideMusic_oggName = "slideMusic_ogg";
	this.slideMusic_ogg = null;
	this.slideMusic_mp3Description = { files : ["slideMusic.mp3"], type : "blob", name : "slideMusic_mp3"};
	this.slideMusic_mp3Name = "slideMusic_mp3";
	this.slideMusic_mp3 = null;
	this.music_goes_here_txtDescription = { files : ["music-goes-here.txt"], type : "blob", name : "music_goes_here_txt"};
	this.music_goes_here_txtName = "music_goes_here_txt";
	this.music_goes_here_txt = null;
};
$hxClasses["kha.BlobList"] = kha_BlobList;
kha_BlobList.__name__ = ["kha","BlobList"];
kha_BlobList.prototype = {
	music_goes_here_txt: null
	,music_goes_here_txtName: null
	,music_goes_here_txtDescription: null
	,music_goes_here_txtLoad: function(done) {
		kha_Assets.loadBlob("music_goes_here_txt",function(blob) {
			done();
		});
	}
	,music_goes_here_txtUnload: function() {
		this.music_goes_here_txt.unload();
		this.music_goes_here_txt = null;
	}
	,slideMusic_mp3: null
	,slideMusic_mp3Name: null
	,slideMusic_mp3Description: null
	,slideMusic_mp3Load: function(done) {
		kha_Assets.loadBlob("slideMusic_mp3",function(blob) {
			done();
		});
	}
	,slideMusic_mp3Unload: function() {
		this.slideMusic_mp3.unload();
		this.slideMusic_mp3 = null;
	}
	,slideMusic_ogg: null
	,slideMusic_oggName: null
	,slideMusic_oggDescription: null
	,slideMusic_oggLoad: function(done) {
		kha_Assets.loadBlob("slideMusic_ogg",function(blob) {
			done();
		});
	}
	,slideMusic_oggUnload: function() {
		this.slideMusic_ogg.unload();
		this.slideMusic_ogg = null;
	}
	,click2_ogg: null
	,click2_oggName: null
	,click2_oggDescription: null
	,click2_oggLoad: function(done) {
		kha_Assets.loadBlob("click2_ogg",function(blob) {
			done();
		});
	}
	,click2_oggUnload: function() {
		this.click2_ogg.unload();
		this.click2_ogg = null;
	}
	,sounds_go_here_txt: null
	,sounds_go_here_txtName: null
	,sounds_go_here_txtDescription: null
	,sounds_go_here_txtLoad: function(done) {
		kha_Assets.loadBlob("sounds_go_here_txt",function(blob) {
			done();
		});
	}
	,sounds_go_here_txtUnload: function() {
		this.sounds_go_here_txt.unload();
		this.sounds_go_here_txt = null;
	}
	,success_ogg: null
	,success_oggName: null
	,success_oggDescription: null
	,success_oggLoad: function(done) {
		kha_Assets.loadBlob("success_ogg",function(blob) {
			done();
		});
	}
	,success_oggUnload: function() {
		this.success_ogg.unload();
		this.success_ogg = null;
	}
	,__class__: kha_BlobList
};
var kha_FontList = function() {
	this.robotoDescription = { files : ["roboto.ttf"], type : "font", name : "roboto"};
	this.robotoName = "roboto";
	this.roboto = null;
	this.LuckiestGuyDescription = { files : ["LuckiestGuy.ttf"], type : "font", name : "LuckiestGuy"};
	this.LuckiestGuyName = "LuckiestGuy";
	this.LuckiestGuy = null;
};
$hxClasses["kha.FontList"] = kha_FontList;
kha_FontList.__name__ = ["kha","FontList"];
kha_FontList.prototype = {
	LuckiestGuy: null
	,LuckiestGuyName: null
	,LuckiestGuyDescription: null
	,LuckiestGuyLoad: function(done) {
		kha_Assets.loadFont("LuckiestGuy",function(font) {
			done();
		});
	}
	,LuckiestGuyUnload: function() {
		this.LuckiestGuy.unload();
		this.LuckiestGuy = null;
	}
	,roboto: null
	,robotoName: null
	,robotoDescription: null
	,robotoLoad: function(done) {
...
kha_Assets.loadEverything = function(callback) {
	...
	while(_g8 < _g17.length) {
		var sound1 = [_g17[_g8]];
		++_g8;
		if(StringTools.endsWith(sound1[0],"Load")) (Reflect.field(kha_Assets.sounds,sound1[0]))((function(sound1) {
			return function() {
				var sound2 = Reflect.field(kha_Assets.sounds,sound1[0].substring(0,sound1[0].length - 4));
				sound2.uncompress((function() {
					return function() {
						--filesLeft;
						if(filesLeft == 0) callback();
					};
...
kha_LoaderImpl.getSoundFormats = function() {
	...
	element = _this.createElement("audio");
	var formats = [];
	if(element.canPlayType("audio/mp4") != "") formats.push("mp4");
	if(kha_SystemImpl._hasWebAudio || element.canPlayType("audio/ogg") != "") formats.push("ogg");
	return formats;
};
	...
	request.onreadystatechange = function() {
		...
		if(request.status >= 200 && request.status < 400) {
			...
			if(arrayBuffer != null) {
				...
				haxe_Log.trace("Error loading " + desc.files[0],{ fileName : "LoaderImpl.hx", lineNumber : 103, className : "kha.LoaderImpl", methodName : "loadBlobFromDescription"});
				window.console.log("loadBlob failed");
			}
			done(new kha_internal_BytesBlob(bytes));
		} else {
			haxe_Log.trace("Error loading " + desc.files[0],{ fileName : "LoaderImpl.hx", lineNumber : 109, className : "kha.LoaderImpl", methodName : "loadBlobFromDescription"});
			window.console.log("loadBlob failed");
		}
	};
	request.send(null);
	...
	,uncompress: function(done) {
		...
		if(header.channel == 1) {
			...
			while(_g < count) {
				...
				this.uncompressedData[i * 2] = val;
				var val1 = soundBytes.getFloat(i * 4);
				this.uncompressedData[i * 2 + 1] = val1;
			}
		} else {
			var this2;
...
kha_SystemImpl.initEx = function(title,options,windowCallback,callback) {
	haxe_Log.trace("initEx is not supported on the html5 target, running init() with first window options",{ fileName : "SystemImpl.hx", lineNumber : 68, className : "kha.SystemImpl", methodName : "initEx"});
...
kha_SystemImpl.loadFinished = function() {
	...
	try {
		...
		if (e instanceof js__$Boot_HaxeError) e = e.val;
		haxe_Log.trace(e,{ fileName : "SystemImpl.hx", lineNumber : 245, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
...
kha_Position.Fixed = function(v) { var $x = ["Fixed",1,v]; $x.__enum__ = kha_Position; return $x; };
...
kha_TargetDisplay.ById = function(id) { var $x = ["ById",1,id]; $x.__enum__ = kha_TargetDisplay; return $x; };
...
kha_audio2_Audio1._mix = function(samples,buffer) {
	...
	while(_g5 < samples) {
		var i5 = _g5++;
		var val2 = kha_audio2_Audio1.max(kha_audio2_Audio1.min(kha_audio2_Audio1.sampleCache2[i5],1.0),-1.0);
...
kha_audio2_ogg_vorbis__$VorbisDecodeState_FindPageResult.Found = function(end,last) { var $x = ["Found",0,end,last]; $x.__enum__ = kha_audio2_ogg_vorbis__$VorbisDecodeState_FindPageResult; return $x; };
...
var kha_graphics4_TextureFormat = $hxClasses["kha.graphics4.TextureFormat"] = { __ename__ : true, __constructs__ : ["RGBA32","L8","RGBA128","DEPTH16","RGBA64"] };
...
kha_js_AudioElementAudio.play = function(sound,loop,stream) {
	...
	sound.element.play();
	return new kha_js_AEAudioChannel(sound.element);
};
...
var kha_js_WebAudioSound = function(filename,done) {
	...
	request.onload = function() {
		_g.compressedData = haxe_io_Bytes.ofData(request.response);
		_g.uncompressedData = null;
		done(_g);
	};
	request.send(null);
};
...
kha_js_WebAudioSound.prototype = $extend(kha_Sound.prototype,{
	...
	,uncompress: function(done) {
		...
		kha_audio2_Audio._context.decodeAudioData(this.compressedData.b.bufferValue,function(buffer) {
			...
			_g.uncompressedData = this1;
			if(buffer.numberOfChannels == 1) {
				var _g2 = 0;
				var _g1 = buffer.getChannelData(0).length;
				while(_g2 < _g1) {
					var i = _g2++;
					var val = buffer.getChannelData(0)[i];
					_g.uncompressedData[i * 2] = val;
					var val1 = buffer.getChannelData(0)[i];
					_g.uncompressedData[i * 2 + 1] = val1;
				}
			} else {
				var _g21 = 0;
				var _g11 = buffer.getChannelData(0).length;
				while(_g21 < _g11) {
					var i1 = _g21++;
					var val2 = buffer.getChannelData(0)[i1];
					_g.uncompressedData[i1 * 2] = val2;
					var val3 = buffer.getChannelData(1)[i1];
					_g.uncompressedData[i1 * 2 + 1] = val3;
				}
			}
			_g.compressedData = null;
			done();
		},function() {
			_g.superUncompress(done);
		});
	}
...
tweenx909_EaseX.sineIn = function(t) {
	if(t == 0) return 0; else if(t == 1) return 1; else return 1 - Math.cos(t * 1.57079632679489656);
};
tweenx909_EaseX.sineOut = function(t) {
	if(t == 0) return 0; else if(t == 1) return 1; else return Math.sin(t * 1.57079632679489656);
};
...
tweenx909_EaseX.sineOutIn = function(t) {
	if(t == 0) return 0; else if(t == 1) return 1; else if(t < 0.5) return 0.5 * Math.sin(t * 2 * 1.57079632679489656); else return -0.5 * Math.cos((t * 2 - 1) * 1.57079632679489656) + 1;
};
...
tweenx909_EaseX.bounceIn = function(t) {
	if((t = 1 - t) < 0.363636363636363646) return 1 - 7.5625 * t * t;
	if(t < 0.727272727272727293) return 1 - (7.5625 * (t -= 0.545454545454545414) * t + 0.75);
	if(t < 0.909090909090909061) return 1 - (7.5625 * (t -= 0.818181818181818232) * t + 0.9375);
...
tweenx909_EaseX.bounceOut = function(t) {
	...
	if(t < 0.727272727272727293) return 7.5625 * (t -= 0.545454545454545414) * t + 0.75;
	if(t < 0.909090909090909061) return 7.5625 * (t -= 0.818181818181818232) * t + 0.9375;
	return 7.5625 * (t -= 0.954545454545454586) * t + 0.984375;
};
tweenx909_EaseX.bounceInOut = function(t) {
	if(t < 0.5) {
		if((t = 1 - t * 2) < 0.363636363636363646) return (1 - 7.5625 * t * t) * 0.5;
		if(t < 0.727272727272727293) return (1 - (7.5625 * (t -= 0.545454545454545414) * t + 0.75)) * 0.5;
		if(t < 0.909090909090909061) return (1 - (7.5625 * (t -= 0.818181818181818232) * t + 0.9375)) * 0.5;
		return (1 - (7.5625 * (t -= 0.954545454545454586) * t + 0.984375)) * 0.5;
	} else {
		if((t = t * 2 - 1) < 0.363636363636363646) return 7.5625 * t * t * 0.5 + 0.5;
		if(t < 0.727272727272727293) return (7.5625 * (t -= 0.545454545454545414) * t + 0.75) * 0.5 + 0.5;
		if(t < 0.909090909090909061) return (7.5625 * (t -= 0.818181818181818232) * t + 0.9375) * 0.5 + 0.5;
		return (7.5625 * (t -= 0.954545454545454586) * t + 0.984375) * 0.5 + 0.5;
	}
};
tweenx909_EaseX.bounceOutIn = function(t) {
	if(t < 0.5) {
		if((t = t * 2) < 0.363636363636363646) return 0.5 * (7.5625 * t * t);
		if(t < 0.727272727272727293) return 0.5 * (7.5625 * (t -= 0.545454545454545414) * t + 0.75);
		if(t < 0.909090909090909061) return 0.5 * (7.5625 * (t -= 0.818181818181818232) * t + 0.9375);
		return 0.5 * (7.5625 * (t -= 0.954545454545454586) * t + 0.984375);
	} else {
		if((t = 1 - (t * 2 - 1)) < 0.363636363636363646) return 0.5 - 0.5 * (7.5625 * t * t) + 0.5;
		if(t < 0.727272727272727293) return 0.5 - 0.5 * (7.5625 * (t -= 0.545454545454545414) * t + 0.75) + 0.5;
		if(t < 0.909090909090909061) return 0.5 - 0.5 * (7.5625 * (t -= 0.818181818181818232) * t + 0.9375) + 0.5;
...
var tweenx909_EventX = $hxClasses["tweenx909.EventX"] = { __ename__ : true, __constructs__ : ["PLAY","DELAY","HEAD","UPDATE","FOOT","INTERVAL","REPEAT","REST","FINISH","STOP"] };
...
tweenx909_EaseX.PI_H = 1.57079632679489656;
